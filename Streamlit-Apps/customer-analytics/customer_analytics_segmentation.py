...
def load_scaler_pca_kmeans_pca():
    scaler = pickle.load(open('D:\My_Projects\Jupyter\Streamlit-Apps\customer-analytics\scaler.pickle', 'rb'))
    pca = pickle.load(open('D:\My_Projects\Jupyter\Streamlit-Apps\customer-analytics\pca.pickle', 'rb'))
    kmeans_pca = pickle.load(open('D:\My_Projects\Jupyter\Streamlit-Apps\customer-analytics\kmeans_pca.pickle', 'rb'))
